package com.ygg.admin.sdk.montnets.httpget;
...
public class SmsUtil
{
    ...
    public String[] MongateGetDeliverForGet(Params params, String host, boolean bKeepAlive, Object connection)
    {
        String[] Result = null;
        ...
        try
        {
            ...
            if (!bKeepAlive)
            {
                Message = executeGet(params, host + url + "MongateGetDeliver");
            }
            else
            {
                Message = executeGet(params, host + url + "MongateGetDeliver", (HttpClient)connection);
            }
    ...
    public Integer MongateQueryBalanceForGet(Params params, String host, boolean bKeepAlive, Object connection)
    {
        Integer result = null;
        try
        {
            ...
            if (!bKeepAlive)
            {
                Message = executeGet(params, host + url + "MongateQueryBalance");
            }
            else
            {
                Message = executeGet(params, host + url + "MongateQueryBalance", (HttpClient)connection);
            }
    ...
    public String MongateSendSubmitForGet(Params params, String host, boolean bKeepAlive, Object connection)
    {
        String result = null;
        try
        {
            ...
            if (!bKeepAlive)
            {
                Message = executeGet(params, host + url + "MongateSendSubmit");
            }
            else
            {
                Message = executeGet(params, host + url + "MongateSendSubmit", (HttpClient)connection);
            }
            if (Message != null && Message != "")
            {
                Document doc = DocumentHelper.parseText(Message);
    ...
    public String MongateMULTIXSendForGet(Params params, String host, boolean bKeepAlive, Object connection)
        throws Exception
    {
        String result = null;
        try
        {
            ...
            if (!bKeepAlive)
            {
                Message = executeGet(params, host + url + "MongateMULTIXSend");
            }
            else
            {
                Message = executeGet(params, host + url + "MongateMULTIXSend", (HttpClient)connection);
            }
            if (Message != null && Message != "")
            {
                Document doc = DocumentHelper.parseText(Message);
     ...
     * @throws Exception
     */
    private String executeGet(Object obj, String httpUrl)
        throws Exception
    {
     ...
     * @throws Exception
     */
    private String executeGet(Object obj, String httpUrl, HttpClient httpclient)
        throws Exception
    {
