 ...
 *
 */
public class CHttpGet implements ISms
{
    
    public int SendMultixSms(StringBuffer strPtMsgId, String strUserId, String strPwd, String host, List<MULTIX_MT> MultixMt, boolean bKeepAlive, Object connection)
    {
        int returnInt = -200;
        try
        {
            ...
            result = new SmsUtil().MongateMULTIXSendForGet(p, host, bKeepAlive, connection);
    ...
    public int SendSms(StringBuffer strPtMsgId, String strUserId, String strPwd, String host, String strMobiles, String strMessage, String strSubPort, String strUserMsgId,
        boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateSendSubmitForGet(p, host, bKeepAlive, connection);
            if (result != null && !"".equals(result) && result.length() > 10)
            {
                returnInt = 0;
                strPtMsgId.append(result);
    ...
    public int QueryBalance(StringBuffer nBalance, String strUserId, String strPwd, String host, boolean bKeepAlive, Object connection)
    {
        Integer result = null;
        try
        {
            ...
            result = new SmsUtil().MongateQueryBalanceForGet(p, host, bKeepAlive, connection);
        }
        catch (Exception e)
        {
    ...
    public List<MO_PACK> GetMo(String strUserId, String strPwd, String host, boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateGetDeliverForGet(p, host, bKeepAlive, connection);
    ...
    public List<RPT_PACK> GetRpt(String strUserId, String strPwd, String host, boolean bKeepAlive, Object connection)
    {
