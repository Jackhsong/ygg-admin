...
public class SmsUtil
{
     ...
     */
    public String[] MongateGetDeliverForPost(Params params, String host, boolean bKeepAlive, Object connection)
    {
        String[] Result = null;
     ...
     * 返回值：正数或0：帐户可发送条数
    		       -1:登陆失败
    		                 其他错误见附录
     */
    public Integer MongateQueryBalanceForPost(Params params, String host, boolean bKeepAlive, Object connection)
    {
        Integer result = null;
     ...
     * 返回值：错误描述对应说明
    		...
    		错误返回：-1	参数为空。信息、电话号码等有空指针，登陆失败
    				...
    				-999	web服务器内部错误
     */
    public String MongateSendSubmitForPost(Params params, String host, boolean bKeepAlive, Object connection)
    {
        String result = null;
        try
        {
     ...
     * 注意：由于单个短信结构体中各元素间，以及短信包中各个短信结构体间采用的分隔符分隔，所以要求短信结构体中各元素的值中不能包含分隔符（,和/），否则将导致解析错误。
    		...
    		-999	web服务器内部错误
     */
    public String MongateMULTIXSendForPost(Params params, String host, boolean bKeepAlive, Object connection)
    {
        String result = null;
        try
        {
     ...
     * @throws Exception
     */
    private String executePost(Object obj, String httpUrl)
        throws Exception
    {
     ...
     * @throws Exception
     */
    private String executePost(Object obj, String httpUrl, HttpClient httpclient)
        throws Exception
    {
