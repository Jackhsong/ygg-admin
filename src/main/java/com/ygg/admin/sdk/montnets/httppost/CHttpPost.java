package com.ygg.admin.sdk.montnets.httppost;
...
public class CHttpPost implements ISms
{
    ...
    public List<MO_PACK> GetMo(String strUserId, String strPwd, String host, boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateGetDeliverForPost(p, host, bKeepAlive, connection);
    ...
    public int QueryBalance(StringBuffer nBalance, String strUserId, String strPwd, String host, boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateQueryBalanceForPost(p, host, bKeepAlive, connection);
        }
        catch (Exception e)
        {
            System.out.println("出现了异常，访问地址配置错误！");
    ...
    public int SendMultixSms(StringBuffer strPtMsgId, String strUserId, String strPwd, String host, List<MULTIX_MT> MultixMt, boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateMULTIXSendForPost(p, host, bKeepAlive, connection);
        ...
        boolean bKeepAlive, Object connection)
    {
        ...
        try
        {
            ...
            result = new SmsUtil().MongateSendSubmitForPost(p, host, bKeepAlive, connection);
