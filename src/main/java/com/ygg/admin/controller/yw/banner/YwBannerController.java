package com.ygg.admin.controller.yw.banner;
...
import com.ygg.admin.service.yw.banner.YwBannerService;
import com.ygg.admin.util.CommonEnum;
import com.ygg.admin.util.DateTimeUtil;

@Controller
@RequestMapping("ywBanner")
public class YwBannerController
{
    private Logger logger = Logger.getLogger(YwBannerController.class);
    
    @Resource(name = "ywBannerService")
        ...
        throws Exception
    {
        ...
        mv.setViewName("ywBanner/ywBannerForm");
        return mv;
    }
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("ywBanner/ywBannerManage");
        return mv;
    }
...
//        bannerWindow.setImage((image.indexOf(ImageUtil.getPrefix()) > 0) ? image : (image + ImageUtil.getPrefix() + ImageUtil.getSuffix(ImageTypeEnum.v1banner.ordinal())));
        ...
        if (editId != 0)
        {
            ...
            BannerWindowEntity bwe = ywBannerService.findBannerWindowById(editId);
            ywBannerService.update(bannerWindow);
        ...
        {
            ywBannerService.save(bannerWindow);
        }
        
        mv.setViewName("redirect:/ywBanner/list");
        return mv;
    }
    ...
    public String jsonBannerWindowInfo(
        ...
        @RequestParam(value = "isDisplay", required = false, defaultValue = "0,1") String isDisplay,//0,1  // 0不展示，1展示
        ...
        throws Exception
    {
        ...
        List<BannerWindowEntity> bannerWindowList = ywBannerService.findAllBannerWindow(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        List<Map<String, Object>> resultList = ywBannerService.packageBannerWindowList(bannerWindowList);
        resultMap.put("rows", resultList);
        int total = ywBannerService.countBannerWindow(para);
        ...
        throws Exception
    {
        ...
        int resultStatus = ywBannerService.updateDisplayCode(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (resultStatus != 1)
        {
    ...
    {
        ModelAndView mv = new ModelAndView();
        BannerWindowEntity bannerWindow = ywBannerService.findBannerWindowById(id);
        ...
        throws Exception
    {
        ...
        para.put("id", id);
        int resultStatus = ywBannerService.updateOrder(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (resultStatus != 1)
        {
            resultMap.put("status", 0);
        ...
        throws Exception
    {
        ...
        boolean isExist = ywBannerService.checkIsExist(para);
        if (!isExist)
        {
            resultMap.put("status", 0);
        ...
        resultMap = ywBannerService.checkProductTime(para);
        return JSON.toJSONString(resultMap);
