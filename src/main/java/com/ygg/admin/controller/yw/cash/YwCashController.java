 ...
 *           识产权保护的内容。                            
 ***************************************************************************/
package com.ygg.admin.controller.yw.cash;
 ...
 */
@Controller
@RequestMapping("/ywCash")
public class YwCashController {
    
    /**日志工具    */
    Logger logger = Logger.getLogger(YwCashController.class);
    
    @Resource(name="ywCashService")
    private YwCashService ywCashService;
    /**
     * 格格福利团推荐
     * @return ModelAndView
     */
    ...
    public ModelAndView list() {
        ModelAndView mv = new ModelAndView("ywcash/list");
        return mv;
    }
    ...
    public Object listInfo(String name,
        ...
        try {
            ...
            param.put("size", rows);
            return JSON.toJSONString(ywCashService.findListInfo(param));
        } catch (Exception e) {
             ...
             @RequestParam(value = "type", required = true) int type)
    {
        ...
        try{
            String fla = ywCashService.updateLog(id,type);
        ...
        throws Exception
    {
        ...
        {
            try{
                String fla = ywCashService.updateLog(Integer.valueOf(it),1);
                if(StringUtils.isNotBlank(fla)){
