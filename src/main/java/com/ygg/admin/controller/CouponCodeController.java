...
public class CouponCodeController
{
    ...
    private Logger log = Logger.getLogger(CouponCodeController.class);
        ...
        throws Exception
    {
        try
        {
            ...
            Map<String, Object> result = couponCodeService.addCouponCode(couponDetailIdAndCountList, startTime, endTime, desc, nums, type, customCode);
        ...
        throws Exception
    {
        ...
        Map<String, Object> resultMap = couponCodeService.findCouponCode(para);
        ...
        throws Exception
    {
        try
        {
            Map<String, Object> result = couponCodeService.updateCouponAvailable(id, isAvailable);
            return JSON.toJSONString(result);
        }
        catch (Exception e)
        {
    ...
    )
    {
        ...
        try
        {
            ...
            mv.setViewName("coupon/codeDetail");
            
            String totalAmount = couponCodeService.findCouponCodeTotoalMoney(id);
        ...
        throws Exception
    {
        ...
        Map<String, Object> resultMap = couponCodeService.findCouponCodeDetail(para);
        return JSON.toJSONString(resultMap);
    }
        ...
        throws Exception
    {
        ...
        //        Map<String, Object> result = couponCodeService.findCouponCodeLiBaoInfo(Integer.parseInt(id));
        //        mv.addObject("couponDetailIdList", result.get("couponDetailIdList"));
        mv.setViewName("coupon/codeLiBaoDetail");
        return mv;
    }
        ...
        throws Exception
    {
        ...
        Map<String, Object> resultMap = couponCodeService.findCouponCodeLiBaoDetail(para);
        return JSON.toJSONString(resultMap);
    }
        ...
        throws Exception
    {
        ...
        Map<String, Object> map = couponCodeService.queryCouponAccount(para);
        ModelAndView mv = new ModelAndView();
