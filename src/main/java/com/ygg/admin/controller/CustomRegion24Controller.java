 ...
 */
@Controller
@RequestMapping("/customRegion24")
public class CustomRegion24Controller
{
    private static Logger logger = Logger.getLogger(CustomRegion24Controller.class);
    
    @Resource
    private CustomRegion24Service customRegion24Service;
    ...
    {
        ModelAndView mv = new ModelAndView("customRegion24/customRegionList");
        return mv;
    }
    ...
    public String jsonCustomRegionInfo(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
        @RequestParam(value = "rows", required = false, defaultValue = "50") int rows, @RequestParam(value = "isAvailable", required = false, defaultValue = "1") String isAvailable)
    {
        ...
        try
        {
            ...
            resultMap = customRegion24Service.jsonCustomRegionInfo(para);
        }
        catch (Exception e)
        {
        ...
        @RequestParam(value = "isAvailable", required = false, defaultValue = "1") int isAvailable)
    {
        ...
        try
        {
            ...
            para.put("isAvailable", isAvailable);
            int status = customRegion24Service.saveOrUpdateCustonRegion(para);
            if (status == 1)
            {
    ...
    public String updateCustomRegionSequence(@RequestParam(value = "id", required = true) int id, @RequestParam(value = "sequence", required = true) int sequence)
    {
        ...
        try
        {
            ...
            int status = customRegion24Service.updateCustomRegionSequence(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
    ...
    public String updateCustomRegionDisplayStatus(@RequestParam(value = "id", required = true) String id, @RequestParam(value = "code", required = true) int code)
    {
        ...
        try
        {
            ...
            int status = customRegion24Service.updateCustomRegionDisplayStatus(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
    ...
    public String updateCustomRegionAvailableStatus(@RequestParam(value = "id", required = true) String id, @RequestParam(value = "code", required = true) int code)
    {
        ...
        try
        {
            ...
            para.put("idList", idList);
            int status = customRegion24Service.updateCustomRegionAvailableStatus(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
     ...
     * @return
     */
    @RequestMapping("/manageLayout/{regionId}")
    public ModelAndView manageLayout(@PathVariable("regionId") int regionId)
    {
        ModelAndView mv = new ModelAndView();
        try
        {
            mv.setViewName("customRegion24/customLayoutList");
            Map<String, Object> resultMap = customRegion24Service.findCustomRegionById(regionId);
        ...
        @RequestParam(value = "rows", required = false, defaultValue = "50") int rows, @RequestParam(value = "regionId", required = true) int regionId)
    {
        ...
        try
        {
            ...
            resultMap = customRegion24Service.jsonCustomLayoutInfo(para);
        }
        catch (Exception e)
        {
            logger.error(e.getMessage(), e);
    ...
    public String updateCustomLayoutDisplayStatus(@RequestParam(value = "layoutId", required = true) String layoutId, @RequestParam(value = "code", required = true) int code)
    {
        ...
        try
        {
            ...
            para.put("idList", idList);
            int status = customRegion24Service.updateCustomLayoutDisplayStatus(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
    ...
    public String updateCustomLayoutSequence(@RequestParam(value = "id", required = true) int id, @RequestParam(value = "sequence", required = true) int sequence)
    {
        ...
        try
        {
            para.put("id", id);
            para.put("sequence", sequence);
            int status = customRegion24Service.updateCustomLayoutSequence(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
     ...
     * @return
     */
    @RequestMapping("/toAdd/{regionId}")
    public ModelAndView toAdd(@PathVariable(value = "regionId") int regionId)
    {
        ModelAndView mv = new ModelAndView("customRegion24/update");
        mv.addObject("regionId", regionId + "");
        ...
        @RequestParam(value = "isDisplay", required = false, defaultValue = "0") int isDisplay)
    {
        ...
        {
            para.put("regionId", regionId);
            CustomLayoutEntity customLayout = new CustomLayoutEntity();
            ...
            int status = customRegion24Service.saveOrUpdateCustomLayout(para);
            if (status == 1)
            {
                result.put("status", 1);
            }
    ...
    @RequestMapping("/toEdit/{regionId}/{layoutId}")
    public ModelAndView toEdit(@PathVariable(value = "regionId") int regionId, @PathVariable(value = "layoutId") int layoutId)
    {
        ModelAndView mv = new ModelAndView();
        Map<String, Object> para = new HashMap<String, Object>();
        try
        {
            ...
            para.put("regionId", regionId);
            Map<String, Object> customLayout = customRegion24Service.findCustomLayoutBydId(para);
            if (customLayout == null)
            {
                mv.setViewName("error/404");
                return mv;
            }
            mv.setViewName("customRegion24/update");
    ...
    public String deleteCustomLayout(@RequestParam(value = "id", required = true) int id)
    {
        try
        {
            return customRegion24Service.deleteCustomLayout(id);
        }
        catch (Exception e)
        {
            Map<String, Object> result = new HashMap<String, Object>();
