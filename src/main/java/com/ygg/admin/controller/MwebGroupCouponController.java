...
@Controller
@RequestMapping("/mwebGroupCoupon")
public class MwebGroupCouponController
{
    private Logger logger = Logger.getLogger(MwebGroupCouponController.class);
    ...
    {
        return "mwebGroupCoupon/couponList";
    }
    
    @RequestMapping("/typeList")
    public String couponTypeList()
    {
        return "mwebGroupCoupon/couponTypeList";
    }
            ...
            throws Exception
    {
        ...
        Map<String, Object> info = mwebGroupCouponService.jsonCouponDetailInfo(para);
    ...
    public String saveOrUpdate(@RequestParam(value = "couponTypeId", required = false, defaultValue = "-1") int id, @RequestParam(value = "type", required = true) int type, //
        ...
        @RequestParam(value = "desc", required = true) String desc, @RequestParam(value = "teamType", required = false, defaultValue = "1") int teamType)
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            if (scopeType == 2)
            {
                MwebGroupProductEntity product = mwebGroupProductService.getProductById(scopeId);
                if (product == null)
                {
            ...
            int result = mwebGroupCouponService.saveOrUpdate(para);
            if (result == 1)
            {
        ...
        throws Exception
    {
        Map<String, Object> para = new HashMap<String, Object>();
        Map<String, Object> resultMap = new HashMap<String, Object>();
        int result = mwebGroupCouponService.updateCouponDetailStatus(id, isAvailable);
        if (result == 1)
        {
            resultMap.put("status", 1);
            // 优惠券改状态
    ...
    public String checkIsInUse(@RequestParam(value = "id", required = true) int couponDetailId)
        throws Exception
    {
        boolean isInUse = mwebGroupCouponService.checkIsInUse(couponDetailId);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        MwebGroupCouponDetailEntity couponDetail = mwebGroupCouponService.findCouponDetailById(couponDetailId);
        if (couponDetail.getScopeType() == 2)
        {
            MwebGroupProductEntity product = mwebGroupProductService.getProductById(couponDetail.getScopeId());
        ...
        throws Exception
    {
        ...
        else
        {
            ...
            {
                scopeName = product.getShortName();
                resultMap.put("status", 1);
            }
        }
     ...
     * @param remark:备注
     * @param operType:操作类型，operType=1批量向accoutId发放优惠券;operType=2批量向name发放优惠券;operType=3向单个accoutId发放优惠券;operType=
     *            4生成单张优惠券
     * @return
     * @throws Exception
     */
    ...
    public String createSingleCoupon(@RequestParam(value = "couponType", required = true) int couponType, @RequestParam(value = "startTime", required = true) String startTime,
        ...
        @RequestParam(value = "operType", required = false, defaultValue = "4") int operType)
            throws Exception
    {
        MwebGroupCouponEntity coupon = new MwebGroupCouponEntity();
        ...
        int result = mwebGroupCouponService.sendCoupon(coupon, null, operType, null);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (result == 1)
        {
            resultMap.put("status", 1);
        ...
        @RequestParam(value = "remark", required = false, defaultValue = "") String remark, @RequestParam(value = "operType", required = true) int operType)
    {
        ...
        try
        {
            ...
            int result = mwebGroupCouponService.sendCoupon(coupon, file, operType, null);
            if (result == -1)
            {
                resultMap.put("status", 0);
            ...
            throws Exception
    {
        ...
        int result = mwebGroupCouponService.sendCoupon(coupon, null, operType, accountId);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (result == 1)
        {
            resultMap.put("status", 1);
            ...
            throws Exception
    {
        ...
        Map<String, Object> info = mwebGroupCouponService.jsonCouponInfo(para);
        return JSON.toJSONString(info);
    }
            ...
            throws Exception
    {
        ...
        List<Map<String, Object>> codeList = mwebGroupCouponService.queryAllCouponType(isAvailable, 1 == isRandomReduce, id);
        Date dateTmp2 = new Date();
        long time = dateTmp2.getTime() - dateTmp1.getTime();
        logger.error("jsonCouponType数据查询完成，一共运行时间【" + (time) + "毫秒】");
    ...
    public ModelAndView couponAccountList(@PathVariable("id") int couponId)
    {
        ...
        try
        {
            String totalMoney = mwebGroupCouponService.findCouponTotalMoney(couponId);// 优惠券总金额
            int useAmount = mwebGroupCouponService.findCouponUsedInfo(couponId);
            mv.addObject("totalAmount", totalMoney);
            mv.addObject("useAmount", useAmount + "");
            mv.addObject("couponId", couponId + "");
            mv.setViewName("mwebGroupCoupon/couponDetailList");
        }
        catch (Exception e)
        {
            logger.error(e.getMessage(), e);
            ...
            throws Exception
    {
        ...
        Map<String, Object> info = mwebGroupCouponService.jsonCouponAccountInfo(para);
        return JSON.toJSONString(info);
    }
        ...
        throws Exception
    {
        ...
        Map<String, Object> map = mwebGroupCouponService.queryCouponAccount(para);
            ...
            throws Exception
    {
        ...
        para.put("max", rows);
        para.put("couponAccountId", couponAccountId);
        Map<String, Object> info = mwebGroupCouponService.jsonCouponOrderDetailInfo(para);
        return JSON.toJSONString(info);
    }
        ...
        throws Exception
    {
        ...
        if (detail.getTeamType() == 1)
        {
            resultMap.put("teamTypeInfo", "仅用于开团");
        }
        else if (detail.getTeamType() == 2)
        {
            resultMap.put("teamTypeInfo", "开团参团均可使用");
        }
