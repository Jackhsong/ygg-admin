...
public interface CouponCodeDao
{
     ...
     * @throws Exception
     */
    int insertCouponCode(CouponCodeEntity couponCode)
        throws Exception;
     ...
     * @throws Exception
     */
    List<CouponCodeEntity> findAllCouponCode(Map<String, Object> para)
        throws Exception;
     ...
     * @throws Exception
     */
    CouponCodeEntity findCouponCodeById(int id)
        throws Exception;
     ...
     * @throws Exception
     */
    CouponDetailEntity findCouponDetailById(int id)
        throws Exception;
     ...
     * @throws Exception
     */
    List<CouponDetailEntity> findCouponDetailByCouponCodeId(int couponCodeId)
        throws Exception;
