package com.ygg.admin.service.yw.sale;
...
public interface YwSaleServcie
{
    
    int save(YwSaleEntity saleWindow)
        throws Exception;
    
    int update(YwSaleEntity saleWindow)
        throws Exception;
    ...
    /**
     * 封装数据 YwSaleEntity --> map
     * 
     * @param dataList
     * @return
     * @throws Exception
     */
    List<Map<String, Object>> packageSaleWindowList(List<YwSaleEntity> saleWindowList, int type, int running)
        throws Exception;
