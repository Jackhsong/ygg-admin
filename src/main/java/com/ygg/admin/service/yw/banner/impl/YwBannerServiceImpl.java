package com.ygg.admin.service.yw.banner.impl;
...
public class YwBannerServiceImpl implements YwBannerService
{
    
    @Resource
    private ProductDao productDao;
    
    @Resource(name = "ywBannerDao")
    private YwBannerDao ywBannerDao = null;
        ...
        throws Exception
    {
        ...
        return ywBannerDao.save(window);
    }
        ...
        throws Exception
    {
        ...
        return ywBannerDao.update(window);
    }
    ...
    public int countBannerWindow(Map<String, Object> para)
        throws Exception
    {
        return ywBannerDao.countBannerWindow(para);
    }
    ...
    public List<BannerWindowEntity> findAllBannerWindow(Map<String, Object> para)
        throws Exception
    {
        return ywBannerDao.findAllBannerWindow(para);
    }
    ...
    public BannerWindowEntity findBannerWindowById(int id)
        throws Exception
    {
        return ywBannerDao.findBannerWindowById(id);
    }
    ...
    public int updateDisplayCode(Map<String, Object> para)
        throws Exception
    {
        return ywBannerDao.updateDisplayCode(para);
    }
        ...
        throws Exception
    {
        ...
        for (BannerWindowEntity bEntity : bList)
        {
            ...
            imageSB.append("<img alt='' src='").append(bEntity.getImage()).append("' style='max-height:50px;'/>");
    ...
    public int updateOrder(Map<String, Object> para)
        throws Exception
    {
        return ywBannerDao.updateOrder(para);
    }
