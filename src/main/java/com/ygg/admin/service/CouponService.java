...
public interface CouponService
{
     ...
     * @throws Exception
     */
    int sendCoupon(CouponEntity coupon, MultipartFile file, int operType, Integer accountId)
        throws Exception;
    ...
    List<Map<String, Object>> getUsedCouponOrderInfoByCouponIdf(Map<String, Object> para)
        throws Exception;
