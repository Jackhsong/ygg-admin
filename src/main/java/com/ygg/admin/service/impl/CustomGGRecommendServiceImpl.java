...
@Service("customGGRecommendService")
public class CustomGGRecommendServiceImpl implements CustomGGRecommendService {

	@Resource
	private CustomGGRecommendDao customGGRecommendDao;
	
	@Override
	public Map<String, Object> findRecommendListInfo(Map<String, Object> param) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("rows", customGGRecommendDao.findRecommendListInfo(param));
		result.put("total", customGGRecommendDao.countRecommendByParam(param));
		return result;
	}
	...
	public int saveOrUpdateRecommend(Map<String, Object> param) throws Exception {
		...
		if(id == null || StringUtils.isBlank(id.toString())) {
			return customGGRecommendDao.saveRecommend(param);
		} else {
			return customGGRecommendDao.updateRecommend(param);
		}
	}
